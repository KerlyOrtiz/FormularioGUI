...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        primaryStage.setTitle("FormularioGUI");
        ...
        row = 0;
        grid.add(new Button("Button"), 1, row++);
        grid.add(new CheckBox("CheckBox"), 1, row++);
        grid.add(new Hyperlink("HiperLink"), 1, row++);
        grid.add(new ToggleButton("ToggleButton"), 1, row++);
        ...
        grid.add(new Label("Label"), 1, row++);
        grid.add(new TextField("Escribir"), 1, row++);
